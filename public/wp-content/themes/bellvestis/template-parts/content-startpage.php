...
<div class="category"><p class="h3">Herr</p></div>
</a>
<a href="#" class="women-category"><img  src="<?php echo $women_category_img['url']; ?>" alt="Women Category" class="women-category-img" >
<div class="category"><p class="h3">Dam</p></div>
</a>
<a href="#" class="kids-category"><img  src="<?php echo $kids_category_img['url']; ?>" alt="Kids Category" class="kids-category-img" >
<div class="category kid"><p class="h3">Barn</p></div>
</a>

<a href="#" class="trends-hero"><img  src="<?php echo $trends_hero_img['url']; ?>" alt="Trends Hero Image" class="trends-hero-img" >
<div class="category trend-title"><p class="h3">Säsongens Trender</p></div>
</a>

<div class="trend-container flex">
<a href="#" class="trend-autumn col-4 mx-auto"><img class="trend-autumn-img" src="<?php echo $trend_autumn_img['url']; ?>" alt="Trend Autumn Image"  ></a>

<div class="trend-box col-6  mx-auto">
...
<a href="#" class="trend-summer"><img  src="<?php echo $trend_summer_img['url']; ?>" alt="Trend summer Image" class="trend-summer-img" ></a>
</div>
...
<div class="category about-read-more"><p class="h3">Läs mer</p></div>
</a>
</a>
